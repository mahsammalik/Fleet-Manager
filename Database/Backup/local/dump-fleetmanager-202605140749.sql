...
-- Started on 2026-05-14 07:49:30
...
-- Completed on 2026-05-14 07:49:30
...
--
-- TOC entry 3791 (class 1262 OID 16384)
...
--
-- TOC entry 264 (class 1255 OID 98755)
-- Name: allocate_overdue_rent_payroll(uuid, uuid, date, numeric); Type: FUNCTION; Schema: public; Owner: fleetadmin
--

CREATE FUNCTION public.allocate_overdue_rent_payroll(p_organization_id uuid, p_driver_id uuid, p_period_start date, p_amount numeric) RETURNS TABLE(vehicle_rental_id uuid, amount numeric)
    LANGUAGE plpgsql STABLE
    AS $$
DECLARE
  rem NUMERIC := ROUND(GREATEST(0, COALESCE(p_amount, 0))::numeric, 2);
  pay NUMERIC;
  rec RECORD;
BEGIN
  ...
  FOR rec IN
    SELECT
      ...
      ROUND(
        GREATEST(
          0,
          COALESCE(vr.total_rent_amount, 0)::numeric - COALESCE(vr.rent_paid_amount, 0)::numeric
        ),
        2
      ) AS unpaid
    ...
    WHERE vr.organization_id = p_organization_id
      ...
      AND vr.rental_end_date < p_period_start
      AND COALESCE(vr.total_rent_amount, 0)::numeric > COALESCE(vr.rent_paid_amount, 0)::numeric
    ORDER BY vr.rental_end_date ASC, vr.id ASC
  LOOP
    EXIT WHEN rem <= 0;
    IF rec.unpaid <= 0 THEN CONTINUE; END IF;
    pay := LEAST(rem, rec.unpaid);
    vehicle_rental_id := rec.rid;
    amount := pay;
    RETURN NEXT;
    rem := rem - pay;
  END LOOP;
...
ALTER FUNCTION public.allocate_overdue_rent_payroll(p_organization_id uuid, p_driver_id uuid, p_period_start date, p_amount numeric) OWNER TO fleetadmin;

--
-- TOC entry 3793 (class 0 OID 0)
-- Dependencies: 264
-- Name: FUNCTION allocate_overdue_rent_payroll(p_organization_id uuid, p_driver_id uuid, p_period_start date, p_amount numeric); Type: COMMENT; Schema: public; Owner: fleetadmin
--

COMMENT ON FUNCTION public.allocate_overdue_rent_payroll(p_organization_id uuid, p_driver_id uuid, p_period_start date, p_amount numeric) IS 'Spreads a payroll overdue rent cap across prior rentals (by end date) for rent_payments ledger rows.';


--
-- TOC entry 262 (class 1255 OID 98742)
-- Name: allocate_rental_fee(uuid, uuid, date, date); Type: FUNCTION; Schema: public; Owner: fleetadmin
--

CREATE FUNCTION public.allocate_rental_fee(p_organization_id uuid, p_driver_id uuid, p_week_start date, p_week_end date) RETURNS TABLE(vehicle_rental_id uuid, amount numeric)
    LANGUAGE plpgsql STABLE
    AS $$
DECLARE
    rec RECORD;
...
ALTER FUNCTION public.allocate_rental_fee(p_organization_id uuid, p_driver_id uuid, p_week_start date, p_week_end date) OWNER TO fleetadmin;

--
-- TOC entry 3794 (class 0 OID 0)
-- Dependencies: 262
-- Name: FUNCTION allocate_rental_fee(p_organization_id uuid, p_driver_id uuid, p_week_start date, p_week_end date); Type: COMMENT; Schema: public; Owner: fleetadmin
--

COMMENT ON FUNCTION public.allocate_rental_fee(p_organization_id uuid, p_driver_id uuid, p_week_start date, p_week_end date) IS 'Per-rental breakdown of calculate_rental_fee: returns (rental_id, prorated_amount) rows.';


--
-- TOC entry 266 (class 1255 OID 98778)
-- Name: allocate_vehicle_rent_pieces(uuid, uuid, date, date, boolean); Type: FUNCTION; Schema: public; Owner: fleetadmin
--

CREATE FUNCTION public.allocate_vehicle_rent_pieces(p_organization_id uuid, p_driver_id uuid, p_week_start date, p_week_end date, p_include_completed boolean) RETURNS TABLE(vehicle_rental_id uuid, amount numeric)
    LANGUAGE plpgsql STABLE
    AS $$
DECLARE
    rec RECORD;
...
ALTER FUNCTION public.allocate_vehicle_rent_pieces(p_organization_id uuid, p_driver_id uuid, p_week_start date, p_week_end date, p_include_completed boolean) OWNER TO fleetadmin;

--
-- TOC entry 3795 (class 0 OID 0)
-- Dependencies: 266
-- Name: FUNCTION allocate_vehicle_rent_pieces(p_organization_id uuid, p_driver_id uuid, p_week_start date, p_week_end date, p_include_completed boolean); Type: COMMENT; Schema: public; Owner: fleetadmin
--

COMMENT ON FUNCTION public.allocate_vehicle_rent_pieces(p_organization_id uuid, p_driver_id uuid, p_week_start date, p_week_end date, p_include_completed boolean) IS 'Fleet-week proration per rental; active-only vs active+completed via flag (matches calculate_rental_fee math).';


--
-- TOC entry 248 (class 1255 OID 98754)
-- Name: calculate_overdue_rent_amount(uuid, uuid, date); Type: FUNCTION; Schema: public; Owner: fleetadmin
--

CREATE FUNCTION public.calculate_overdue_rent_amount(p_organization_id uuid, p_driver_id uuid, p_period_start date) RETURNS numeric
    LANGUAGE sql STABLE
    AS $$
  SELECT ROUND(
    COALESCE(
...
ALTER FUNCTION public.calculate_overdue_rent_amount(p_organization_id uuid, p_driver_id uuid, p_period_start date) OWNER TO fleetadmin;

--
-- TOC entry 3796 (class 0 OID 0)
-- Dependencies: 248
-- Name: FUNCTION calculate_overdue_rent_amount(p_organization_id uuid, p_driver_id uuid, p_period_start date); Type: COMMENT; Schema: public; Owner: fleetadmin
--

COMMENT ON FUNCTION public.calculate_overdue_rent_amount(p_organization_id uuid, p_driver_id uuid, p_period_start date) IS 'Outstanding rent from rentals that ended before the payout period (total_rent − rent_paid, floored per rental).';


--
-- TOC entry 263 (class 1255 OID 90520)
-- Name: calculate_rental_fee(uuid, uuid, date, date); Type: FUNCTION; Schema: public; Owner: fleetadmin
--

CREATE FUNCTION public.calculate_rental_fee(p_organization_id uuid, p_driver_id uuid, p_week_start date, p_week_end date) RETURNS numeric
    LANGUAGE plpgsql STABLE
    AS $$
DECLARE
...
ALTER FUNCTION public.calculate_rental_fee(p_organization_id uuid, p_driver_id uuid, p_week_start date, p_week_end date) OWNER TO fleetadmin;

--
-- TOC entry 3797 (class 0 OID 0)
-- Dependencies: 263
-- Name: FUNCTION calculate_rental_fee(p_organization_id uuid, p_driver_id uuid, p_week_start date, p_week_end date); Type: COMMENT; Schema: public; Owner: fleetadmin
--

COMMENT ON FUNCTION public.calculate_rental_fee(p_organization_id uuid, p_driver_id uuid, p_week_start date, p_week_end date) IS 'Fleet-week vehicle rent: sums prorated overlap with payment period (weekly uses amount * days / 7).';


--
-- TOC entry 260 (class 1255 OID 49580)
...
--
-- TOC entry 265 (class 1255 OID 49582)
...
BEGIN
  ...
  SET
    current_week_rent = rf.cw,
    overdue_rent_amount = rf.od,
    total_rent_deduction = rf.tot,
    vehicle_rental_fee = rf.cw,
  ...
  FROM (
    SELECT
      id,
      calculate_rental_fee(organization_id, driver_id, payment_period_start, payment_period_end)::numeric AS cw,
      calculate_overdue_rent_amount(organization_id, driver_id, payment_period_start)::numeric AS od,
      ROUND(
        (
          calculate_rental_fee(organization_id, driver_id, payment_period_start, payment_period_end)::numeric
          + calculate_overdue_rent_amount(organization_id, driver_id, payment_period_start)::numeric
        )::numeric,
        2
      ) AS tot
    FROM driver_payouts
...
--
-- TOC entry 261 (class 1255 OID 49555)
...
CREATE TABLE public.driver_payouts (
    ...
    commission_base_type character varying(50) DEFAULT 'net_income'::character varying,
    income numeric(12,6) DEFAULT 0 NOT NULL,
    tips numeric(12,6) DEFAULT 0 NOT NULL,
    ...
    current_week_rent numeric(12,2) DEFAULT 0 NOT NULL,
    overdue_rent_amount numeric(12,2) DEFAULT 0 NOT NULL,
    total_rent_deduction numeric(12,2) DEFAULT 0 NOT NULL,
...
-- Dependencies: 221
-- Name: COLUMN driver_payouts.vehicle_rental_fee; Type: COMMENT; Schema: public; Owner: fleetadmin
--

COMMENT ON COLUMN public.driver_payouts.vehicle_rental_fee IS 'Legacy: equals current-period proration (calculate_rental_fee); retained for backward compatibility.';


--
-- TOC entry 3799 (class 0 OID 0)
-- Dependencies: 221
-- Name: COLUMN driver_payouts.gross_income; Type: COMMENT; Schema: public; Owner: fleetadmin
--

COMMENT ON COLUMN public.driver_payouts.gross_income IS 'Glovo ladder: SUM(income+tips) per import row; period rollup; aligns with total_gross_earnings when sources match.';


--
-- TOC entry 3800 (class 0 OID 0)
-- Dependencies: 221
-- Name: COLUMN driver_payouts.net_income; Type: COMMENT; Schema: public; Owner: fleetadmin
--

COMMENT ON COLUMN public.driver_payouts.net_income IS 'Glovo ladder: SUM(venituri+tips-taxa) per row (transparency)';


--
-- TOC entry 3801 (class 0 OID 0)
-- Dependencies: 221
-- Name: COLUMN driver_payouts.commission_base; Type: COMMENT; Schema: public; Owner: fleetadmin
--

COMMENT ON COLUMN public.driver_payouts.commission_base IS 'Period sum of ladder net income (matches net_income); fleet transfer-leg bases remain per earnings row';


--
-- TOC entry 3802 (class 0 OID 0)
-- Dependencies: 221
-- Name: COLUMN driver_payouts.commission_rate; Type: COMMENT; Schema: public; Owner: fleetadmin
--

COMMENT ON COLUMN public.driver_payouts.commission_rate IS 'Driver fleet rate as fraction (e.g. 0.20 for 20%)';


--
-- TOC entry 3803 (class 0 OID 0)
-- Dependencies: 221
-- Name: COLUMN driver_payouts.commission_base_type; Type: COMMENT; Schema: public; Owner: fleetadmin
--

COMMENT ON COLUMN public.driver_payouts.commission_base_type IS 'Which amount fed transfer commission base for this payout row';


--
-- TOC entry 3804 (class 0 OID 0)
-- Dependencies: 221
-- Name: COLUMN driver_payouts.income; Type: COMMENT; Schema: public; Owner: fleetadmin
--

COMMENT ON COLUMN public.driver_payouts.income IS 'Base driver earnings (period sum; excludes tips).';


--
-- TOC entry 3805 (class 0 OID 0)
-- Dependencies: 221
-- Name: COLUMN driver_payouts.tips; Type: COMMENT; Schema: public; Owner: fleetadmin
--

COMMENT ON COLUMN public.driver_payouts.tips IS 'Period sum of driver tips (Bacsis).';


--
-- TOC entry 3806 (class 0 OID 0)
-- Dependencies: 221
-- Name: COLUMN driver_payouts.total_gross_earnings; Type: COMMENT; Schema: public; Owner: fleetadmin
--

COMMENT ON COLUMN public.driver_payouts.total_gross_earnings IS 'Generated: income + tips (true gross for the period).';


--
-- TOC entry 3807 (class 0 OID 0)
-- Dependencies: 221
-- Name: COLUMN driver_payouts.updated_at; Type: COMMENT; Schema: public; Owner: fleetadmin
--

COMMENT ON COLUMN public.driver_payouts.updated_at IS 'Last time this payout row was updated (application-maintained).';


--
-- TOC entry 3808 (class 0 OID 0)
-- Dependencies: 221
-- Name: COLUMN driver_payouts.account_opening_fee; Type: COMMENT; Schema: public; Owner: fleetadmin
--

COMMENT ON COLUMN public.driver_payouts.account_opening_fee IS 'Period sum of row-level account_opening_fee imported from earnings_records.';


--
-- TOC entry 3809 (class 0 OID 0)
-- Dependencies: 221
-- Name: COLUMN driver_payouts.current_week_rent; Type: COMMENT; Schema: public; Owner: fleetadmin
--

COMMENT ON COLUMN public.driver_payouts.current_week_rent IS 'Prorated vehicle rent overlapping the payout period (matches calculate_rental_fee).';


--
-- TOC entry 3810 (class 0 OID 0)
-- Dependencies: 221
-- Name: COLUMN driver_payouts.overdue_rent_amount; Type: COMMENT; Schema: public; Owner: fleetadmin
--

COMMENT ON COLUMN public.driver_payouts.overdue_rent_amount IS 'Sum of unpaid rent from rentals that ended before period start (balance floored at 0 per rental).';


--
-- TOC entry 3811 (class 0 OID 0)
-- Dependencies: 221
-- Name: COLUMN driver_payouts.total_rent_deduction; Type: COMMENT; Schema: public; Owner: fleetadmin
--

COMMENT ON COLUMN public.driver_payouts.total_rent_deduction IS 'Payroll vehicle rent deduction: current_week_rent + overdue_rent_amount; subtracted from raw_net_amount.';
...
CREATE TABLE public.earnings_records (
    ...
    tips numeric(10,2),
    has_cash_commission boolean GENERATED ALWAYS AS ((COALESCE(daily_cash, (0)::numeric) <> (0)::numeric)) STORED,
    commission_base numeric(12,6),
    driver_payout_after_cash numeric(10,2) GENERATED ALWAYS AS (round(((
CASE
    WHEN (COALESCE(platform_fee, (0)::numeric) < (0)::numeric) THEN ((COALESCE(gross_earnings, (0)::numeric) + COALESCE(tips, (0)::numeric)) + COALESCE(platform_fee, (0)::numeric))
    ELSE ((COALESCE(gross_earnings, (0)::numeric) + COALESCE(tips, (0)::numeric)) - COALESCE(platform_fee, (0)::numeric))
END - COALESCE(company_commission, (0)::numeric)) - abs(COALESCE(daily_cash, (0)::numeric))), 2)) STORED
);
...
-- Dependencies: 223
-- Name: COLUMN earnings_records.commission_base; Type: COMMENT; Schema: public; Owner: fleetadmin
--

COMMENT ON COLUMN public.earnings_records.commission_base IS 'Fleet commission numerator for this row (sum rollups to driver_payouts.commission_base). NULL for rows imported before this column existed.';
...
-- Dependencies: 235
-- Name: COLUMN payout_adjustments.amount; Type: COMMENT; Schema: public; Owner: fleetadmin
--

COMMENT ON COLUMN public.payout_adjustments.amount IS 'Signed change in remaining_debt (new - previous).';


--
-- TOC entry 3814 (class 0 OID 0)
-- Dependencies: 235
-- Name: COLUMN payout_adjustments.previous_remaining_debt; Type: COMMENT; Schema: public; Owner: fleetadmin
--

COMMENT ON COLUMN public.payout_adjustments.previous_remaining_debt IS 'remaining_debt_amount before this adjustment.';


--
-- TOC entry 3815 (class 0 OID 0)
-- Dependencies: 235
-- Name: COLUMN payout_adjustments.new_remaining_debt; Type: COMMENT; Schema: public; Owner: fleetadmin
--

COMMENT ON COLUMN public.payout_adjustments.new_remaining_debt IS 'remaining_debt_amount after this adjustment.';


--
-- TOC entry 3816 (class 0 OID 0)
-- Dependencies: 235
-- Name: COLUMN payout_adjustments.applied_amount; Type: COMMENT; Schema: public; Owner: fleetadmin
--

COMMENT ON COLUMN public.payout_adjustments.applied_amount IS 'Positive magnitude of reduction for forgive/cash_received; NULL for adjust/carry_forward.';


--
-- TOC entry 237 (class 1259 OID 98756)
-- Name: payout_rent_entries; Type: TABLE; Schema: public; Owner: fleetadmin
--

CREATE TABLE public.payout_rent_entries (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    driver_payout_id uuid NOT NULL,
    vehicle_rental_id uuid,
    entry_type character varying(50) NOT NULL,
    amount numeric(12,2) NOT NULL,
    description text,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT payout_rent_entries_entry_type_check CHECK (((entry_type)::text = ANY ((ARRAY['current_week'::character varying, 'overdue'::character varying, 'adjustment'::character varying])::text[])))
);


ALTER TABLE public.payout_rent_entries OWNER TO fleetadmin;

--
-- TOC entry 236 (class 1259 OID 98711)
-- Name: rent_payments; Type: TABLE; Schema: public; Owner: fleetadmin
--

CREATE TABLE public.rent_payments (
    id uuid DEFAULT public.uuid_generate_v4() NOT NULL,
    organization_id uuid NOT NULL,
    vehicle_rental_id uuid NOT NULL,
    driver_payout_id uuid NOT NULL,
    amount numeric(12,2) NOT NULL,
    payment_method character varying(50) DEFAULT 'payroll_deduction'::character varying NOT NULL,
...
ALTER TABLE public.rent_payments OWNER TO fleetadmin;
...
CREATE TABLE public.vehicle_rentals (
    ...
    rent_paid_amount numeric(12,2) DEFAULT 0 NOT NULL,
...
--
-- TOC entry 3782 (class 0 OID 49535)
-- Dependencies: 233
...
--
-- TOC entry 3781 (class 0 OID 49532)
-- Dependencies: 232
...
--
-- TOC entry 3779 (class 0 OID 24984)
-- Dependencies: 230
...
--
-- TOC entry 3771 (class 0 OID 16489)
-- Dependencies: 219
...
8d59e715-d134-43a7-bafe-7109147e64cd	670032ab-e447-4736-97dd-c17ea637fc0c	deposit_not_required	No deposit requested for this rental	0b070cf9-3d06-4bff-af41-b0ae7591e027	\N	{"rental_id": "40dbbe8b-0e0d-4ff3-9b95-32b22cd23560", "vehicle_id": "8e97b6f6-a8d8-46c0-bf8e-eeb816b19a51", "deposit_amount": 0, "fallback_rate_amount": 600}	2026-05-06 21:32:08.183941
06f9834a-f458-4432-a3c0-c656f5d98dcd	670032ab-e447-4736-97dd-c17ea637fc0c	deposit_not_required	No deposit requested for this rental	0b070cf9-3d06-4bff-af41-b0ae7591e027	\N	{"rental_id": "d5414d56-8742-4412-8b5f-62463cbf2fce", "vehicle_id": "8e97b6f6-a8d8-46c0-bf8e-eeb816b19a51", "deposit_amount": 0, "fallback_rate_amount": 0}	2026-05-06 21:32:45.886431
fcc35ca5-1401-4423-8b3d-e342331a116a	670032ab-e447-4736-97dd-c17ea637fc0c	deposit_not_required	No deposit requested for this rental	0b070cf9-3d06-4bff-af41-b0ae7591e027	\N	{"rental_id": "2922f390-afb2-4593-b930-349953c9dd80", "vehicle_id": "8e97b6f6-a8d8-46c0-bf8e-eeb816b19a51", "deposit_amount": 0, "fallback_rate_amount": 600}	2026-05-06 21:33:54.250269
b5a42161-d091-4936-bbcd-b0055ebfa36b	670032ab-e447-4736-97dd-c17ea637fc0c	deposit_not_required	No deposit requested for this rental	0b070cf9-3d06-4bff-af41-b0ae7591e027	\N	{"rental_id": "dce4f8d2-0193-412c-9206-182b29f86221", "vehicle_id": "8e97b6f6-a8d8-46c0-bf8e-eeb816b19a51", "deposit_amount": 0, "fallback_rate_amount": 600}	2026-05-06 21:35:17.311956
be272b1a-6657-4a04-9c2c-56b4dee3af27	670032ab-e447-4736-97dd-c17ea637fc0c	deposit_not_required	No deposit requested for this rental	0b070cf9-3d06-4bff-af41-b0ae7591e027	\N	{"rental_id": "75052422-faed-4cc4-afea-999b12bc0579", "vehicle_id": "8e97b6f6-a8d8-46c0-bf8e-eeb816b19a51", "deposit_amount": 0, "fallback_rate_amount": 600}	2026-05-06 21:37:29.952229
12a9f05a-f8f6-4f49-adf9-83603addb1e1	670032ab-e447-4736-97dd-c17ea637fc0c	deposit_not_required	No deposit requested for this rental	0b070cf9-3d06-4bff-af41-b0ae7591e027	\N	{"rental_id": "e6aa890f-8a17-4b0c-a25c-682618039edc", "vehicle_id": "8e97b6f6-a8d8-46c0-bf8e-eeb816b19a51", "deposit_amount": 0, "fallback_rate_amount": 600}	2026-05-07 07:01:09.09104
9ce899f8-7da5-4012-8112-fa681968d0db	670032ab-e447-4736-97dd-c17ea637fc0c	deposit_not_required	No deposit requested for this rental	0b070cf9-3d06-4bff-af41-b0ae7591e027	\N	{"rental_id": "e38011ed-21cf-4f94-8ade-c0fec9d19de4", "vehicle_id": "8e97b6f6-a8d8-46c0-bf8e-eeb816b19a51", "deposit_amount": 0, "fallback_rate_amount": 600}	2026-05-07 21:35:40.816136
056deee3-ea1b-4f78-b3c3-a6c3ea0498d4	670032ab-e447-4736-97dd-c17ea637fc0c	deposit_not_required	No deposit requested for this rental	0b070cf9-3d06-4bff-af41-b0ae7591e027	\N	{"rental_id": "1126cb0a-3f91-478c-81cf-2ca3512a8a65", "vehicle_id": "8e97b6f6-a8d8-46c0-bf8e-eeb816b19a51", "deposit_amount": 0, "fallback_rate_amount": 600}	2026-05-07 21:38:32.674858
010906b8-bed9-4acd-be97-84c0aa84027f	670032ab-e447-4736-97dd-c17ea637fc0c	deposit_not_required	No deposit requested for this rental	0b070cf9-3d06-4bff-af41-b0ae7591e027	\N	{"rental_id": "abd41d3c-0a23-4c0d-870b-bef5400a4499", "vehicle_id": "8e97b6f6-a8d8-46c0-bf8e-eeb816b19a51", "deposit_amount": 0, "fallback_rate_amount": 600}	2026-05-07 21:44:12.603908
bdacd818-3ee8-427d-9a96-3d52de67b181	670032ab-e447-4736-97dd-c17ea637fc0c	deposit_not_required	No deposit requested for this rental	0b070cf9-3d06-4bff-af41-b0ae7591e027	\N	{"rental_id": "a8ff4dda-d05e-4772-b187-6c38cd23c9df", "vehicle_id": "8e97b6f6-a8d8-46c0-bf8e-eeb816b19a51", "deposit_amount": 0, "fallback_rate_amount": 600}	2026-05-07 21:48:27.417562
c390920b-baed-482b-9480-ad720c13a48a	670032ab-e447-4736-97dd-c17ea637fc0c	deposit_not_required	No deposit requested for this rental	0b070cf9-3d06-4bff-af41-b0ae7591e027	\N	{"rental_id": "e195c5a0-97c9-4286-b69b-2e899b150148", "vehicle_id": "8e97b6f6-a8d8-46c0-bf8e-eeb816b19a51", "deposit_amount": 0, "fallback_rate_amount": 600}	2026-05-07 21:50:38.534216
5b156d8c-75aa-4c3b-8f10-e6ae44ed5420	670032ab-e447-4736-97dd-c17ea637fc0c	deposit_not_required	No deposit requested for this rental	0b070cf9-3d06-4bff-af41-b0ae7591e027	\N	{"rental_id": "9a356af3-0741-4f45-aaf0-43f7f3e03efc", "vehicle_id": "8e97b6f6-a8d8-46c0-bf8e-eeb816b19a51", "deposit_amount": 0, "fallback_rate_amount": 600}	2026-05-07 21:52:09.450324
72c6a4c0-aaf0-4b3a-9d4e-f5b2aa783f11	670032ab-e447-4736-97dd-c17ea637fc0c	deposit_not_required	No deposit requested for this rental	0b070cf9-3d06-4bff-af41-b0ae7591e027	\N	{"rental_id": "157206c0-101b-460e-85e1-cf57d4d9486f", "vehicle_id": "8e97b6f6-a8d8-46c0-bf8e-eeb816b19a51", "deposit_amount": 0, "fallback_rate_amount": 600}	2026-05-08 06:41:17.52573
7d713fa2-bb61-45c4-83aa-59e75a90345d	670032ab-e447-4736-97dd-c17ea637fc0c	deposit_not_required	No deposit requested for this rental	0b070cf9-3d06-4bff-af41-b0ae7591e027	\N	{"rental_id": "2a6262f7-a6c0-447b-a2ee-0d1d13c58bdc", "vehicle_id": "8e97b6f6-a8d8-46c0-bf8e-eeb816b19a51", "deposit_amount": 0, "fallback_rate_amount": 600}	2026-05-08 06:55:17.693056
d4b5726f-2ba0-4b46-b3f2-6ed0745518dc	670032ab-e447-4736-97dd-c17ea637fc0c	deposit_not_required	No deposit requested for this rental	0b070cf9-3d06-4bff-af41-b0ae7591e027	\N	{"rental_id": "cac575f1-7461-4a2c-a7dd-2f5d99887a68", "vehicle_id": "8e97b6f6-a8d8-46c0-bf8e-eeb816b19a51", "deposit_amount": 0, "fallback_rate_amount": 600}	2026-05-08 07:03:13.300322
d88625f7-e428-4f1f-9bda-4fc713f6ffe2	670032ab-e447-4736-97dd-c17ea637fc0c	deposit_not_required	No deposit requested for this rental	0b070cf9-3d06-4bff-af41-b0ae7591e027	\N	{"rental_id": "2e9b5195-0ec5-4922-9696-ef46450ddca5", "vehicle_id": "8e97b6f6-a8d8-46c0-bf8e-eeb816b19a51", "deposit_amount": 0, "fallback_rate_amount": 600}	2026-05-08 07:04:44.451614
bc70552c-16fb-4f32-a359-0b2f6015a5c4	670032ab-e447-4736-97dd-c17ea637fc0c	deposit_not_required	No deposit requested for this rental	0b070cf9-3d06-4bff-af41-b0ae7591e027	\N	{"rental_id": "14b99c09-2b89-4eb3-89cb-7be8d89ee6d4", "vehicle_id": "8e97b6f6-a8d8-46c0-bf8e-eeb816b19a51", "deposit_amount": 0, "fallback_rate_amount": 600}	2026-05-08 07:06:51.651451
e813d49f-3f49-4a91-b2a9-7b7a02387827	670032ab-e447-4736-97dd-c17ea637fc0c	deposit_not_required	No deposit requested for this rental	0b070cf9-3d06-4bff-af41-b0ae7591e027	\N	{"rental_id": "c56be3db-d98f-44b4-ae09-67006a41110e", "vehicle_id": "8e97b6f6-a8d8-46c0-bf8e-eeb816b19a51", "deposit_amount": 0, "fallback_rate_amount": 600}	2026-05-08 07:09:35.48995
96dd3e6d-1bbf-4a82-90d9-94bc28caf48c	670032ab-e447-4736-97dd-c17ea637fc0c	deposit_not_required	No deposit requested for this rental	0b070cf9-3d06-4bff-af41-b0ae7591e027	\N	{"rental_id": "51fe9e0e-fa66-4272-b68d-9c3922c7aaa8", "vehicle_id": "8e97b6f6-a8d8-46c0-bf8e-eeb816b19a51", "deposit_amount": 0, "fallback_rate_amount": 600}	2026-05-08 07:11:49.53415
ce81403b-5e7d-411a-81aa-05d02c4567bc	670032ab-e447-4736-97dd-c17ea637fc0c	deposit_not_required	No deposit requested for this rental	0b070cf9-3d06-4bff-af41-b0ae7591e027	\N	{"rental_id": "807de731-7b81-46d3-95bc-0dc569bc1d33", "vehicle_id": "8e97b6f6-a8d8-46c0-bf8e-eeb816b19a51", "deposit_amount": 0, "fallback_rate_amount": 600}	2026-05-08 07:15:44.970984
69224335-067d-4977-be5b-a903646e4dc3	670032ab-e447-4736-97dd-c17ea637fc0c	deposit_not_required	No deposit requested for this rental	0b070cf9-3d06-4bff-af41-b0ae7591e027	\N	{"rental_id": "3f45da40-342d-4b60-a7de-d0b5276b9bab", "vehicle_id": "8e97b6f6-a8d8-46c0-bf8e-eeb816b19a51", "deposit_amount": 0, "fallback_rate_amount": 600}	2026-05-08 09:49:10.06112
984fffab-52d2-4c0b-90db-98df3c2b9b50	670032ab-e447-4736-97dd-c17ea637fc0c	deposit_not_required	No deposit requested for this rental	0b070cf9-3d06-4bff-af41-b0ae7591e027	\N	{"rental_id": "5aecc5e4-df17-4b02-9076-62d60dc37c72", "vehicle_id": "8e97b6f6-a8d8-46c0-bf8e-eeb816b19a51", "deposit_amount": 0, "fallback_rate_amount": 600}	2026-05-08 09:57:29.703001
c2337dd6-e490-4105-9e6c-725076c6973a	670032ab-e447-4736-97dd-c17ea637fc0c	deposit_not_required	No deposit requested for this rental	0b070cf9-3d06-4bff-af41-b0ae7591e027	\N	{"rental_id": "a8e9ea81-25a5-43a1-a0ce-479e47c972d6", "vehicle_id": "8e97b6f6-a8d8-46c0-bf8e-eeb816b19a51", "deposit_amount": 0, "fallback_rate_amount": 600}	2026-05-08 10:51:03.545463
25a5f79a-9484-4078-978b-7808d4cf557e	670032ab-e447-4736-97dd-c17ea637fc0c	deposit_not_required	No deposit requested for this rental	0b070cf9-3d06-4bff-af41-b0ae7591e027	\N	{"rental_id": "788cf79f-82ec-48f5-826c-cf29f3d4dcb9", "vehicle_id": "8e97b6f6-a8d8-46c0-bf8e-eeb816b19a51", "deposit_amount": 0, "fallback_rate_amount": 600}	2026-05-08 13:38:42.611767
6dca5a6b-329a-49b0-be2e-65462b4a5c24	670032ab-e447-4736-97dd-c17ea637fc0c	deposit_not_required	No deposit requested for this rental	0b070cf9-3d06-4bff-af41-b0ae7591e027	\N	{"rental_id": "8c006427-0c5b-4d1e-a49d-7ca62d273ba5", "vehicle_id": "8e97b6f6-a8d8-46c0-bf8e-eeb816b19a51", "deposit_amount": 0, "fallback_rate_amount": 600}	2026-05-08 13:42:42.352217
093c1897-3937-45f0-9f13-8365a3f4e1aa	670032ab-e447-4736-97dd-c17ea637fc0c	deposit_not_required	No deposit requested for this rental	0b070cf9-3d06-4bff-af41-b0ae7591e027	\N	{"rental_id": "05d327d4-f20d-4845-99bf-0b13780daf6e", "vehicle_id": "8e97b6f6-a8d8-46c0-bf8e-eeb816b19a51", "deposit_amount": 0, "fallback_rate_amount": 600}	2026-05-08 13:44:15.213228
c006bc1f-b721-4d30-aa95-afe67e3b4727	670032ab-e447-4736-97dd-c17ea637fc0c	deposit_not_required	No deposit requested for this rental	0b070cf9-3d06-4bff-af41-b0ae7591e027	\N	{"rental_id": "372ecad4-f5e8-4217-94a2-be64d29ec682", "vehicle_id": "8e97b6f6-a8d8-46c0-bf8e-eeb816b19a51", "deposit_amount": 0, "fallback_rate_amount": 600}	2026-05-08 13:46:12.230671
6d15265b-e358-4693-82c8-867d94006b16	670032ab-e447-4736-97dd-c17ea637fc0c	deposit_not_required	No deposit requested for this rental	0b070cf9-3d06-4bff-af41-b0ae7591e027	\N	{"rental_id": "dbb463fd-3f6c-4125-a3c4-3648b149d48c", "vehicle_id": "8e97b6f6-a8d8-46c0-bf8e-eeb816b19a51", "deposit_amount": 0, "fallback_rate_amount": 600}	2026-05-08 13:48:53.948375
c21edad1-5d89-4bcc-9939-93ba7c00e7cc	670032ab-e447-4736-97dd-c17ea637fc0c	deposit_not_required	No deposit requested for this rental	0b070cf9-3d06-4bff-af41-b0ae7591e027	\N	{"rental_id": "cb5dcc2f-318e-4742-98e0-ab1f77603020", "vehicle_id": "8e97b6f6-a8d8-46c0-bf8e-eeb816b19a51", "deposit_amount": 0, "fallback_rate_amount": 600}	2026-05-08 20:49:02.706958
843dadee-3deb-4bb9-8937-1f896a1df4da	670032ab-e447-4736-97dd-c17ea637fc0c	deposit_not_required	No deposit requested for this rental	0b070cf9-3d06-4bff-af41-b0ae7591e027	\N	{"rental_id": "5b07e908-2107-44ec-93fc-ec453937e48b", "vehicle_id": "8e97b6f6-a8d8-46c0-bf8e-eeb816b19a51", "deposit_amount": 0, "fallback_rate_amount": 600}	2026-05-09 05:32:05.868355
3c7f3d90-2219-45bc-996c-994e662c090c	670032ab-e447-4736-97dd-c17ea637fc0c	deposit_not_required	No deposit requested for this rental	0b070cf9-3d06-4bff-af41-b0ae7591e027	\N	{"rental_id": "3ef2509f-c7a3-4370-85d4-e66ab41b7f74", "vehicle_id": "8e97b6f6-a8d8-46c0-bf8e-eeb816b19a51", "deposit_amount": 0, "fallback_rate_amount": 600}	2026-05-09 05:35:36.221424
e26767e8-8a1c-4427-95bd-c3fa0a9f07bd	670032ab-e447-4736-97dd-c17ea637fc0c	deposit_not_required	No deposit requested for this rental	0b070cf9-3d06-4bff-af41-b0ae7591e027	\N	{"rental_id": "cb6f3fa7-a0bf-4a11-9569-477519c143a6", "vehicle_id": "8e97b6f6-a8d8-46c0-bf8e-eeb816b19a51", "deposit_amount": 0, "fallback_rate_amount": 600}	2026-05-09 05:36:56.469834
7c7e155d-f9e0-4676-a1a3-28be62296896	670032ab-e447-4736-97dd-c17ea637fc0c	deposit_not_required	No deposit requested for this rental	0b070cf9-3d06-4bff-af41-b0ae7591e027	\N	{"rental_id": "4250f047-7b86-498a-9059-da56860aa2bb", "vehicle_id": "8e97b6f6-a8d8-46c0-bf8e-eeb816b19a51", "deposit_amount": 0, "fallback_rate_amount": 600}	2026-05-09 05:40:03.267808
e22c8cac-0bc7-447d-983f-3dcd30fdb05f	670032ab-e447-4736-97dd-c17ea637fc0c	deposit_not_required	No deposit requested for this rental	0b070cf9-3d06-4bff-af41-b0ae7591e027	\N	{"rental_id": "8dea14b8-a6f4-4e18-b126-3734fbb970ae", "vehicle_id": "8e97b6f6-a8d8-46c0-bf8e-eeb816b19a51", "deposit_amount": 0, "fallback_rate_amount": 600}	2026-05-09 06:08:29.749605
4bd7881f-b5de-4fd4-bb2d-b99d8e854d21	670032ab-e447-4736-97dd-c17ea637fc0c	deposit_not_required	No deposit requested for this rental	0b070cf9-3d06-4bff-af41-b0ae7591e027	\N	{"rental_id": "4b8076dd-728b-42e5-9167-677295ec13aa", "vehicle_id": "8e97b6f6-a8d8-46c0-bf8e-eeb816b19a51", "deposit_amount": 0, "fallback_rate_amount": 600}	2026-05-09 06:16:43.753714
839836c7-6ae2-49f2-90e3-c16f9272d0c5	670032ab-e447-4736-97dd-c17ea637fc0c	deposit_not_required	No deposit requested for this rental	0b070cf9-3d06-4bff-af41-b0ae7591e027	\N	{"rental_id": "97038988-9714-4236-b81a-f7935ef2304d", "vehicle_id": "8e97b6f6-a8d8-46c0-bf8e-eeb816b19a51", "deposit_amount": 0, "fallback_rate_amount": 600}	2026-05-09 06:18:02.058795
c145c1ae-a937-4661-a429-06fa1ba36749	670032ab-e447-4736-97dd-c17ea637fc0c	deposit_not_required	No deposit requested for this rental	0b070cf9-3d06-4bff-af41-b0ae7591e027	\N	{"rental_id": "a15d2221-3ac1-44de-a14a-fb2082a5b87b", "vehicle_id": "8e97b6f6-a8d8-46c0-bf8e-eeb816b19a51", "deposit_amount": 0, "fallback_rate_amount": 600}	2026-05-09 06:19:20.504111
5851256a-1bbd-4bd0-a706-a60b8c6537b9	670032ab-e447-4736-97dd-c17ea637fc0c	deposit_not_required	No deposit requested for this rental	0b070cf9-3d06-4bff-af41-b0ae7591e027	\N	{"rental_id": "8fab6a48-40d4-43ec-9e72-e6f8f30d1f32", "vehicle_id": "8e97b6f6-a8d8-46c0-bf8e-eeb816b19a51", "deposit_amount": 0, "fallback_rate_amount": 600}	2026-05-09 20:56:33.116893
de9b066f-9c95-44d2-8e38-84bcf54a3348	670032ab-e447-4736-97dd-c17ea637fc0c	vehicle_rental_roll_forward	Rental rolled forward to 2026-05-11–2026-05-17	0b070cf9-3d06-4bff-af41-b0ae7591e027	\N	{"next_end": "2026-05-17", "next_start": "2026-05-11", "vehicle_id": "8e97b6f6-a8d8-46c0-bf8e-eeb816b19a51", "prior_rental_id": "8fab6a48-40d4-43ec-9e72-e6f8f30d1f32"}	2026-05-09 20:56:46.741692
\.


--
-- TOC entry 3770 (class 0 OID 16457)
-- Dependencies: 218
...
--
-- TOC entry 3772 (class 0 OID 16535)
-- Dependencies: 221
-- Data for Name: driver_payouts; Type: TABLE DATA; Schema: public; Owner: fleetadmin
--

COPY public.driver_payouts (id, organization_id, driver_id, payment_period_start, payment_period_end, company_commission, bonuses, penalties, adjustments, net_driver_payout, payment_status, payment_date, payment_method, transaction_ref, notes, approved_by, approved_at, created_at, total_platform_fees, total_net_earnings, total_daily_cash, vehicle_rental_id, vehicle_rental_fee, platform_id, raw_net_amount, debt_amount, debt_applied_amount, remaining_debt_amount, gross_income, net_income, commission_base, commission_rate, commission_base_type, income, tips, updated_at, account_opening_fee, current_week_rent, overdue_rent_amount, total_rent_deduction) FROM stdin;
\.


--
-- TOC entry 3769 (class 0 OID 16432)
-- Dependencies: 217
...
670032ab-e447-4736-97dd-c17ea637fc0c	322e3576-685b-4a3b-9975-152c39ee7c03	\N	Rakesh	Kumar	eymanorrider05@gmail.com	0779375836	\N	\N	\N	\N	\N	\N	active	9.00	20.00	\N	\N	\N	2026-05-06 07:51:38.957275	2026-05-09 20:56:46.725789	f	\N	\N	percentage	0.00	0.00	4579029	\N	8e97b6f6-a8d8-46c0-bf8e-eeb816b19a51	\N	\N	\N	f	\N
...
--
-- TOC entry 3780 (class 0 OID 33140)
-- Dependencies: 231
...
--
-- TOC entry 3773 (class 0 OID 16589)
-- Dependencies: 222
...
--
-- TOC entry 3774 (class 0 OID 16607)
-- Dependencies: 223
-- Data for Name: earnings_records; Type: TABLE DATA; Schema: public; Owner: fleetadmin
--

COPY public.earnings_records (id, import_id, driver_id, platform, trip_date, trip_count, gross_earnings, platform_fee, net_earnings, company_commission, driver_payout, commission_type, created_at, total_transfer_earnings, daily_cash, account_opening_fee, vehicle_rental_id, vehicle_rental_fee, tips, commission_base) FROM stdin;
\.


--
-- TOC entry 3767 (class 0 OID 16400)
-- Dependencies: 215
...
322e3576-685b-4a3b-9975-152c39ee7c03	Eyemamor	muhammadikramjnd@gmail.com	\N	\N	\N	{"glovoCommissionBaseType": "net_income"}	2026-03-05 17:57:03.135341	2026-03-05 17:57:03.135341	0.1000
\.


--
-- TOC entry 3783 (class 0 OID 57751)
-- Dependencies: 235
-- Data for Name: payout_adjustments; Type: TABLE DATA; Schema: public; Owner: fleetadmin
--

COPY public.payout_adjustments (id, organization_id, payout_id, amount, reason, adjustment_type, created_by, created_at, previous_remaining_debt, new_remaining_debt, applied_amount) FROM stdin;
\.


--
-- TOC entry 3785 (class 0 OID 98756)
-- Dependencies: 237
-- Data for Name: payout_rent_entries; Type: TABLE DATA; Schema: public; Owner: fleetadmin
--

COPY public.payout_rent_entries (id, driver_payout_id, vehicle_rental_id, entry_type, amount, description, created_at) FROM stdin;
\.


--
-- TOC entry 3784 (class 0 OID 98711)
-- Dependencies: 236
-- Data for Name: rent_payments; Type: TABLE DATA; Schema: public; Owner: fleetadmin
--

COPY public.rent_payments (id, organization_id, vehicle_rental_id, driver_payout_id, amount, payment_method, paid_at, created_at) FROM stdin;
\.


--
-- TOC entry 3768 (class 0 OID 16413)
-- Dependencies: 216
...
--
-- TOC entry 3778 (class 0 OID 16751)
-- Dependencies: 229
...
--
-- TOC entry 3777 (class 0 OID 16723)
-- Dependencies: 228
...
--
-- TOC entry 3776 (class 0 OID 16686)
-- Dependencies: 227
-- Data for Name: vehicle_rentals; Type: TABLE DATA; Schema: public; Owner: fleetadmin
--

COPY public.vehicle_rentals (id, vehicle_id, driver_id, organization_id, rental_start_date, rental_end_date, rental_type, total_rent_amount, deposit_amount, payment_status, payment_date, payment_method, payment_reference, status, notes, created_by, created_at, updated_at, deposit_status, deposit_paid_at, deposit_refunded_at, deposit_deduction_amount, deposit_deduction_reason, rent_paid_amount, is_recurring, auto_renew_interval, max_renewal_date, renewed_from_id) FROM stdin;
\.


--
-- TOC entry 3775 (class 0 OID 16659)
-- Dependencies: 226
...
8e97b6f6-a8d8-46c0-bf8e-eeb816b19a51	322e3576-685b-4a3b-9975-152c39ee7c03	car	Hyundai	sonoto	2021	RED	B122pal	94569579458	Petrol	Auto	\N	0.00	600.00	0.00	2026-06-07	2027-04-04	rented	670032ab-e447-4736-97dd-c17ea637fc0c	\N	2026-03-27 16:20:09.719936	2026-05-09 20:56:46.725789
\.


--
-- TOC entry 3545 (class 2606 OID 24997)
...
--
-- TOC entry 3508 (class 2606 OID 16497)
...
--
-- TOC entry 3512 (class 2606 OID 16548)
...
--
-- TOC entry 3493 (class 2606 OID 16445)
...
--
-- TOC entry 3550 (class 2606 OID 33148)
...
--
-- TOC entry 3517 (class 2606 OID 16596)
...
--
-- TOC entry 3485 (class 2606 OID 16410)
...
--
-- TOC entry 3556 (class 2606 OID 57760)
...
--
-- TOC entry 3567 (class 2606 OID 98765)
-- Name: payout_rent_entries payout_rent_entries_pkey; Type: CONSTRAINT; Schema: public; Owner: fleetadmin
--

ALTER TABLE ONLY public.payout_rent_entries
    ADD CONSTRAINT payout_rent_entries_pkey PRIMARY KEY (id);


--
-- TOC entry 3561 (class 2606 OID 98720)
-- Name: rent_payments rent_payments_pkey; Type: CONSTRAINT; Schema: public; Owner: fleetadmin
--
...
--
-- TOC entry 3563 (class 2606 OID 98722)
-- Name: rent_payments uq_rent_payments_payout_rental; Type: CONSTRAINT; Schema: public; Owner: fleetadmin
--

ALTER TABLE ONLY public.rent_payments
    ADD CONSTRAINT uq_rent_payments_payout_rental UNIQUE (driver_payout_id, vehicle_rental_id);
...
--
-- TOC entry 3543 (class 2606 OID 16761)
...
--
-- TOC entry 3540 (class 2606 OID 16734)
...
--
-- TOC entry 3536 (class 2606 OID 16702)
...
--
-- TOC entry 3526 (class 2606 OID 16675)
...
--
-- TOC entry 3528 (class 2606 OID 16673)
...
--
-- TOC entry 3546 (class 1259 OID 25015)
...
--
-- TOC entry 3547 (class 1259 OID 25013)
...
--
-- TOC entry 3548 (class 1259 OID 25014)
...
--
-- TOC entry 3509 (class 1259 OID 16509)
...
--
-- TOC entry 3510 (class 1259 OID 16508)
...
--
-- TOC entry 3504 (class 1259 OID 16487)
...
--
-- TOC entry 3505 (class 1259 OID 16515)
...
--
-- TOC entry 3506 (class 1259 OID 16488)
...
--
-- TOC entry 3513 (class 1259 OID 33161)
...
--
-- TOC entry 3514 (class 1259 OID 16624)
...
--
-- TOC entry 3515 (class 1259 OID 57715)
...
--
-- TOC entry 3494 (class 1259 OID 16639)
...
--
-- TOC entry 3496 (class 1259 OID 16584)
...
--
-- TOC entry 3497 (class 1259 OID 16456)
...
--
-- TOC entry 3498 (class 1259 OID 16485)
...
--
-- TOC entry 3499 (class 1259 OID 16750)
...
--
-- TOC entry 3500 (class 1259 OID 16486)
...
--
-- TOC entry 3501 (class 1259 OID 16784)
...
--
-- TOC entry 3520 (class 1259 OID 49579)
...
--
-- TOC entry 3551 (class 1259 OID 33159)
...
--
-- TOC entry 3552 (class 1259 OID 33160)
...
--
-- TOC entry 3553 (class 1259 OID 57777)
...
--
-- TOC entry 3554 (class 1259 OID 57776)
...
--
-- TOC entry 3564 (class 1259 OID 98776)
-- Name: idx_payout_rent_entries_payout; Type: INDEX; Schema: public; Owner: fleetadmin
--

CREATE INDEX idx_payout_rent_entries_payout ON public.payout_rent_entries USING btree (driver_payout_id);


--
-- TOC entry 3565 (class 1259 OID 98777)
-- Name: idx_payout_rent_entries_rental; Type: INDEX; Schema: public; Owner: fleetadmin
--

CREATE INDEX idx_payout_rent_entries_rental ON public.payout_rent_entries USING btree (vehicle_rental_id);


--
-- TOC entry 3557 (class 1259 OID 98740)
-- Name: idx_rent_payments_org_paid_at; Type: INDEX; Schema: public; Owner: fleetadmin
--

CREATE INDEX idx_rent_payments_org_paid_at ON public.rent_payments USING btree (organization_id, paid_at);


--
-- TOC entry 3558 (class 1259 OID 98739)
-- Name: idx_rent_payments_payout; Type: INDEX; Schema: public; Owner: fleetadmin
--

CREATE INDEX idx_rent_payments_payout ON public.rent_payments USING btree (driver_payout_id);


--
-- TOC entry 3559 (class 1259 OID 98738)
-- Name: idx_rent_payments_rental; Type: INDEX; Schema: public; Owner: fleetadmin
--

CREATE INDEX idx_rent_payments_rental ON public.rent_payments USING btree (vehicle_rental_id);


--
-- TOC entry 3529 (class 1259 OID 24979)
...
--
-- TOC entry 3530 (class 1259 OID 24974)
...
--
-- TOC entry 3531 (class 1259 OID 24975)
...
--
-- TOC entry 3486 (class 1259 OID 16483)
...
--
-- TOC entry 3487 (class 1259 OID 16484)
...
--
-- TOC entry 3541 (class 1259 OID 16782)
...
--
-- TOC entry 3537 (class 1259 OID 16742)
...
--
-- TOC entry 3538 (class 1259 OID 16740)
...
--
-- TOC entry 3532 (class 1259 OID 24980)
...
--
-- TOC entry 3533 (class 1259 OID 16749)
...
--
-- TOC entry 3534 (class 1259 OID 98750)
-- Name: idx_vehicle_rentals_renewal; Type: INDEX; Schema: public; Owner: fleetadmin
--

CREATE INDEX idx_vehicle_rentals_renewal ON public.vehicle_rentals USING btree (rental_end_date, is_recurring, status) WHERE ((is_recurring = true) AND ((status)::text = 'active'::text));


--
-- TOC entry 3521 (class 1259 OID 24973)
...
--
-- TOC entry 3522 (class 1259 OID 24978)
...
--
-- TOC entry 3523 (class 1259 OID 24976)
...
--
-- TOC entry 3524 (class 1259 OID 24977)
...
--
-- TOC entry 3619 (class 2620 OID 49581)
...
--
-- TOC entry 3620 (class 2620 OID 74202)
-- Name: earnings_records trg_earnings_records_payout_after_cash; Type: TRIGGER; Schema: public; Owner: fleetadmin
--

CREATE TRIGGER trg_earnings_records_payout_after_cash BEFORE INSERT OR UPDATE OF gross_earnings, platform_fee, tips, company_commission, daily_cash, total_transfer_earnings ON public.earnings_records FOR EACH ROW EXECUTE FUNCTION public.trg_enforce_driver_payout_after_cash();


--
-- TOC entry 3606 (class 2606 OID 25008)
...
--
-- TOC entry 3607 (class 2606 OID 25003)
...
--
-- TOC entry 3608 (class 2606 OID 24998)
...
--
-- TOC entry 3578 (class 2606 OID 16498)
...
--
-- TOC entry 3579 (class 2606 OID 16503)
...
--
-- TOC entry 3574 (class 2606 OID 16468)
...
--
-- TOC entry 3575 (class 2606 OID 16510)
...
--
-- TOC entry 3576 (class 2606 OID 16478)
...
--
-- TOC entry 3580 (class 2606 OID 16559)
...
--
-- TOC entry 3582 (class 2606 OID 16549)
...
--
-- TOC entry 3583 (class 2606 OID 49574)
...
--
-- TOC entry 3569 (class 2606 OID 16743)
...
--
-- TOC entry 3570 (class 2606 OID 16579)
...
--
-- TOC entry 3571 (class 2606 OID 16446)
...
--
-- TOC entry 3572 (class 2606 OID 16451)
...
--
-- TOC entry 3609 (class 2606 OID 33154)
...
--
-- TOC entry 3610 (class 2606 OID 33149)
...
--
-- TOC entry 3584 (class 2606 OID 16602)
...
--
-- TOC entry 3587 (class 2606 OID 16614)
...
--
-- TOC entry 3588 (class 2606 OID 49568)
...
--
-- TOC entry 3573 (class 2606 OID 24943)
...
--
-- TOC entry 3614 (class 2606 OID 98723)
-- Name: rent_payments fk_rent_payments_org; Type: FK CONSTRAINT; Schema: public; Owner: fleetadmin
--

ALTER TABLE ONLY public.rent_payments
    ADD CONSTRAINT fk_rent_payments_org FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON DELETE CASCADE;


--
-- TOC entry 3615 (class 2606 OID 98733)
-- Name: rent_payments fk_rent_payments_payout; Type: FK CONSTRAINT; Schema: public; Owner: fleetadmin
--

ALTER TABLE ONLY public.rent_payments
    ADD CONSTRAINT fk_rent_payments_payout FOREIGN KEY (driver_payout_id) REFERENCES public.driver_payouts(id) ON DELETE CASCADE;


--
-- TOC entry 3616 (class 2606 OID 98728)
-- Name: rent_payments fk_rent_payments_rental; Type: FK CONSTRAINT; Schema: public; Owner: fleetadmin
--

ALTER TABLE ONLY public.rent_payments
    ADD CONSTRAINT fk_rent_payments_rental FOREIGN KEY (vehicle_rental_id) REFERENCES public.vehicle_rentals(id) ON DELETE CASCADE;


--
-- TOC entry 3593 (class 2606 OID 24963)
...
--
-- TOC entry 3594 (class 2606 OID 24968)
...
--
-- TOC entry 3595 (class 2606 OID 24958)
...
--
-- TOC entry 3589 (class 2606 OID 24953)
...
--
-- TOC entry 3590 (class 2606 OID 24948)
...
--
-- TOC entry 3611 (class 2606 OID 57771)
...
--
-- TOC entry 3612 (class 2606 OID 57761)
...
--
-- TOC entry 3613 (class 2606 OID 57766)
...
--
-- TOC entry 3617 (class 2606 OID 98766)
-- Name: payout_rent_entries payout_rent_entries_driver_payout_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: fleetadmin
--

ALTER TABLE ONLY public.payout_rent_entries
    ADD CONSTRAINT payout_rent_entries_driver_payout_id_fkey FOREIGN KEY (driver_payout_id) REFERENCES public.driver_payouts(id) ON DELETE CASCADE;


--
-- TOC entry 3618 (class 2606 OID 98771)
-- Name: payout_rent_entries payout_rent_entries_vehicle_rental_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: fleetadmin
--

ALTER TABLE ONLY public.payout_rent_entries
    ADD CONSTRAINT payout_rent_entries_vehicle_rental_id_fkey FOREIGN KEY (vehicle_rental_id) REFERENCES public.vehicle_rentals(id) ON DELETE SET NULL;


--
-- TOC entry 3568 (class 2606 OID 16427)
...
--
-- TOC entry 3602 (class 2606 OID 16767)
...
--
-- TOC entry 3603 (class 2606 OID 16777)
...
--
-- TOC entry 3605 (class 2606 OID 16772)
...
--
-- TOC entry 3601 (class 2606 OID 16735)
...
--
-- TOC entry 3596 (class 2606 OID 16718)
...
--
-- TOC entry 3597 (class 2606 OID 16708)
...
--
-- TOC entry 3598 (class 2606 OID 16713)
...
--
-- TOC entry 3599 (class 2606 OID 98745)
-- Name: vehicle_rentals vehicle_rentals_renewed_from_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: fleetadmin
--

ALTER TABLE ONLY public.vehicle_rentals
    ADD CONSTRAINT vehicle_rentals_renewed_from_id_fkey FOREIGN KEY (renewed_from_id) REFERENCES public.vehicle_rentals(id);
...
--
-- TOC entry 3592 (class 2606 OID 16676)
